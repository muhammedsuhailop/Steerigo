...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({
    ...
    const mobileTransform = isMobile && isCollapsed ? "-translate-x-full" : "translate-x-0";

    const adminMenuItems: SidebarItem[] = [
        { id: "dashboard", label: "Dashboard", icon: "RiDashboardLine", path: "/admin/dashboard" },
        ...
        { id: "tickets", label: "Tickets", icon: "RiHeadphoneLine", path: "/admin/tickets", badge: 12 },
        { id: "settings", label: "Settings", icon: "RiSettingsLine", path: "/admin/settings" },
    ];

    return (
        <div className={`${baseClasses} ${widthClasses} ${mobileTransform} ${className} transition-transform duration-300`}>
            <div className="flex flex-col h-full">
                {/* Logo */}
                <div className="h-16 flex items-center justify-center border-b border-gray-200">
                    <Logo size={isCollapsed && !isMobile ? "sm" : "md"} variant={isCollapsed && !isMobile ? "square" : "horizontal"} />
                </div>
