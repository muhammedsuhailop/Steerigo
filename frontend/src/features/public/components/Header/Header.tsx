                            ...
                            <>
                                ...
                                <div className="relative" ref={navigateDropdownRef}>
                                    ...
                                    >
                                        ...
                                        <RiArrowDropDownLine
                                            className={`w-5 h-5 flex-shrink-0 leading-none transition-transform duration-200 ${isNavigateDropdownOpen ? "rotate-180" : ""
                                                }`}
                                        />
                                    </button>
                                ...
                                <div className="relative" ref={profileDropdownRef}>
                                    ...
                                    >
                                        ...
                                        {/* Dropdown arrow */}
                                        <RiArrowDropDownLine
                                            className={`w-5 h-5 flex-shrink-0 transition-transform duration-200 ${isProfileDropdownOpen ? "rotate-180" : ""
                                                }`}
                                        />
                                    </button>
