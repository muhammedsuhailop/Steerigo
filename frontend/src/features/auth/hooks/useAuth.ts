...
import { logout as logoutAction, clearError, initializeAuth, initiateGoogleAuth } from '../store/authSlice';
...
const userRole = useAppSelector(selectUserRole);
  ...
  // Check if user is a regular user/rider
  const isUser = useCallback(() => {
    return userRole === 'Rider';
  }, [userRole]);

  // Google login function - matches existing implementation
