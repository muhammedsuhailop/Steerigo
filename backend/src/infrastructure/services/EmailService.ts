...
export class EmailService implements IEmailService {
  ...
  async sendVerificationOtp(
    ...
    try {
      await this.sendEmail(
        email,
        "Steerigo - Email Verification Code",
        this.getVerificationOtpTemplate(otp, userName),
      );

      Logger.info("Verification OTP email sent successfully", {
        email,
      });
    } catch (error) {
  ...
  async sendPasswordResetOtp(
    ...
    try {
      await this.sendEmail(
        email,
        "Steerigo - Password Reset Code",
        this.getPasswordResetOtpTemplate(otp, userName),
      );
  ...
  async sendPasswordResetConfirmation(
    ...
    try {
      await this.sendEmail(
        email,
        "Steerigo - Password Reset Successful",
        this.getPasswordResetConfirmationTemplate(userName),
      );
