...
export type ChatMessageSentEvent = BaseChatEvent<
  "ChatMessageSent",
  ChatMessageSentPayload
>;

export type ChatMessageEditedEvent = BaseChatEvent<
  "ChatMessageEdited",
  ChatMessageEditedPayload
>;

export type ChatMessageDeletedEvent = BaseChatEvent<
  "ChatMessageDeleted",
  ChatMessageDeletedPayload
>;

export type ChatMessageViewedEvent = BaseChatEvent<
  "ChatMessageViewed",
