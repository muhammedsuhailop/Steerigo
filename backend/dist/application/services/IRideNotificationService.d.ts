...
export interface IRideNotificationService {
    ...
    notifyRiderSearchProgress(riderId: string, payload: RideSearchProgressPayload): Promise<void>;
    notifyDriverNewFutureRequest(driverId: string, payload: Omit<FutureRideRequestSentToDriverEvent["payload"], "driverId" | "driverUserId">): Promise<void>;
    ...
    notifyDriverRideRequestExpired(driverId: string, payload: {
        requestId: string;
        requestGroupId: string;
        riderId: string;
        expiredAt: string;
...
//# sourceMappingURL=IRideNotificationService.d.ts.map