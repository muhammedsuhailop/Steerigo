...
export interface IPaymentNotificationService {
    ...
    notifyPaymentFailed(riderId: string, driverUserId: string, payload: PaymentFailedPayload): Promise<void>;
    notifyPaymentCashConfirmed(driverId: string, payload: PaymentCashConfirmedPayload): Promise<void>;
}
//# sourceMappingURL=IPaymentNotificationService.d.ts.map