...
exports.MarkRideAsArrivedUseCase = void 0;
...
let MarkRideAsArrivedUseCase = class MarkRideAsArrivedUseCase {
    ...
    async execute(dto) {
        ...
        try {
            Logger_1.Logger.info("Marking ride as driver arrived", {
            ...
            if (!ride.isAccepted()) {
                return Result_1.Result.failure(RideErrors_1.RideErrors.invalidRideStatusTransition(ride.getStatus(), "ARRIVED", rideId));
            }
            ride.setStatusToArrived();
            const updatedRide = await this.rideRepository.save(ride);
            Logger_1.Logger.info("Ride marked as driver arrived successfully", {
                rideId: updatedRide.getRideId(),
                driverId,
                arrivedAt: updatedRide.getArrivedAt()?.toISOString(),
            });
            const rideArrivedEvent = {
                type: "RideArrived",
                occurredAt: new Date(),
                payload: {
                    rideId: updatedRide.getRideId(),
            ...
            Logger_1.Logger.error("Error marking ride as driver arrived", {
                userId: dto.getUserId(),
                rideId,
...
exports.MarkRideAsArrivedUseCase = MarkRideAsArrivedUseCase;
exports.MarkRideAsArrivedUseCase = MarkRideAsArrivedUseCase = __decorate([
...
], MarkRideAsArrivedUseCase);
//# sourceMappingURL=MarkRideAsArrivedUseCase.js.map