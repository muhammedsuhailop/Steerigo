...
exports.GetUserStatsRequestDto = exports.getUserStatsSchema = void 0;
const ValidationErrors_1 = require("../../../domain/errors/ValidationErrors");
const zod_1 = require("zod");
exports.getUserStatsSchema = zod_1.z
    .object({
...
class GetUserStatsRequestDto {
    ...
    static fromRequest(userId, query) {
        const parsed = exports.getUserStatsSchema.safeParse(query);
        if (!parsed.success) {
        ...
        return new GetUserStatsRequestDto(userId, fromDate, toDate);
    }
    getUserId() {
        return this.userId;
    }
...
//# sourceMappingURL=GetUserStatsRequestDto.js.map