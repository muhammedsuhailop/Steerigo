...
class GetAdminDriverStatsRequestDto {
    constructor(fromDate, toDate) {
        this.fromDate = fromDate;
        this.toDate = toDate;
    }
    static fromRequest(query) {
        const parsed = exports.getAdminDriverStatsSchema.safeParse(query);
        if (!parsed.success) {
...
exports.GetAdminDriverStatsRequestDto = GetAdminDriverStatsRequestDto;
//# sourceMappingURL=GetAdminDriverStatsRequestDto.js.map