...
let OnlinePaymentStrategy = class OnlinePaymentStrategy {
    ...
    getMethod() {
        return PaymentMethod_1.PaymentMethod.ONLINE;
    }
    getSuccessMessage() {
        return PaymentMessages_1.PAYMENT_MESSAGES.ONLINE_ORDER_CREATED;
    }
    async execute({ payment, ride, amount, }) {
        ...
        Logger_1.Logger.info("Online order created", { paymentId: payment.getId(), rideId });
...
exports.OnlinePaymentStrategy = OnlinePaymentStrategy;
exports.OnlinePaymentStrategy = OnlinePaymentStrategy = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(DITypes_1.TYPES.PaymentGatewayService)),
...
//# sourceMappingURL=OnlinePaymentStrategy.js.map