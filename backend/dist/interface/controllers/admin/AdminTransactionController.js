...
const GetAdminTransactionsDto_1 = require("../../../application/dto/admin/GetAdminTransactionsDto");
let AdminTransactionController = class AdminTransactionController {
    constructor(getAdminTransactionsUseCase) {
        this.getAdminTransactionsUseCase = getAdminTransactionsUseCase;
    }
    async getTransactions(req, res) {
        try {
            Logger_1.Logger.info("Admin get transactions request received", {
                query: req.query,
            });
            const dto = GetAdminTransactionsDto_1.GetAdminTransactionsDto.fromRequest(req.query);
...
exports.AdminTransactionController = AdminTransactionController = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(DITypes_1.TYPES.GetAdminTransactionsUseCase)),
