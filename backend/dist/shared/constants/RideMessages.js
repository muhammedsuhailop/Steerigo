...
exports.DRIVER_RIDE_CANCELLATION_ERROR_MESSAGES = exports.RIDE_CANCELLATION_ERROR_MESSAGES = exports.RIDE_ERROR_MESSAGES = exports.RIDE_MESSAGES = void 0;
exports.RIDE_MESSAGES = {
...
exports.RIDE_ERROR_MESSAGES = {
    ...
    DRIVER_HAS_ACTIVE_RIDE: "Driver {{driverId}} already has an active ride: {{rideId}}",
    RIDER_HAS_ACTIVE_RIDE: "Rider {{riderId}} already has an active ride: {{rideId}}",
    INVALID_STATUS_TRANSITION: "Cannot transition ride {{rideId}} from {{from}} to {{to}}",
    RIDE_CREATION_FAILED: "Failed to create ride: {{reason}}",
    UNAUTHORIZED_RIDE_ACCESS: "You are not authorized to access ride {{rideId}}",
    CANNOT_MARK_AS_ARRIVED: "Cannot mark ride {{rideId}} as arrived from status {{currentStatus}}. Only accepted rides can be marked as arrived.",
    CANNOT_RATE_INCOMPLETE_RIDE: "Cannot rate ride {{rideId}} because it is not yet completed",
    ...
    RIDE_NOT_ELIGIBLE_FOR_COUPON: "Ride '{rideId}' with status {{currentStatus}} is not eligible for a coupon",
    INVALID_VERIFICATION_CODE: "Invalid verification code",
};
exports.RIDE_CANCELLATION_ERROR_MESSAGES = {
    ...
    CANNOT_CANCEL_COMPLETED_RIDE: "Ride {{rideId}} cannot be cancelled because it has already been completed.",
    CANNOT_CANCEL_STARTED_RIDE: "Ride {{rideId}} cannot be cancelled after it has started.",
    CHARGE_CALCULATION_FAILED: "Failed to calculate the cancellation charge for ride {{rideId}}: {{reason}}.",
    FARE_RESET_FAILED: "Failed to reset fare breakdown for ride {rideId}: {reason}.",
    INVALID_CANCELLATION_REASON: "{{reason}} is not a valid cancellation reason.",
};
exports.DRIVER_RIDE_CANCELLATION_ERROR_MESSAGES = {
    RIDE_NOT_FOUND: "Ride with ID {{rideId}} was not found.",
    DRIVER_NOT_FOUND: "Driver with user ID {{userId}} was not found.",
    UNAUTHORIZED_CANCELLATION: "Driver {{driverId}} is not authorized to cancel ride {{rideId}}.",
    RIDE_ALREADY_CANCELLED: "Ride {{rideId}} has already been cancelled.",
    CANNOT_CANCEL_COMPLETED_RIDE: "Ride {{rideId}} cannot be cancelled because it has already been completed.",
    CHARGE_CALCULATION_FAILED: "Failed to calculate the cancellation outcome for ride {{rideId}}: {{reason}}.",
    FARE_RESET_FAILED: "Failed to reset fare breakdown for ride {{rideId}}: {{reason}}.",
    INVALID_CANCELLATION_REASON: "{{reason}} is not a valid driver cancellation reason.",
    WALLET_NOT_FOUND: "Wallet not found for driver {{driverId}}.",
};
//# sourceMappingURL=RideMessages.js.map