...
exports.COUPON_MESSAGES = exports.COUPON_ERROR_MESSAGES = void 0;
exports.COUPON_ERROR_MESSAGES = {
    ...
    MINIMUM_AMOUNT_NOT_SATISFIED: "Minimum ride amount of {{minAmount}} is required. Current fare: {{rideAmount}}",
    COUPON_ALREADY_APPLIED: "A coupon is already applied to ride '{{rideId}}'",
    CANNOT_APPLY_COUPON_AFTER_PAYMENT: "Cannot apply coupon for ride {{rideId}} after payment is completed.",
    COUPON_USAGE_LIMIT_EXCEEDED: "You have already reached the maximum usage limit for coupon '{{code}}'.",
...
//# sourceMappingURL=CouponMessages.js.map