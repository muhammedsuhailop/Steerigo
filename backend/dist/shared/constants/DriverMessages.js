...
exports.SEARCH_DRIVER_ERROR_MESSAGES = exports.DRIVER_AVAILABILITY_ERROR_MESSAGES = exports.KYC_ERROR_MESSAGES = exports.DRIVER_ERROR_MESSAGES = exports.DRIVER_MESSAGES = void 0;
exports.DRIVER_MESSAGES = {
    UNAUTHORIZED: "Unauthorized",
    MISSING_FIELDS_PREFIX: "Missing required fields: ",
    DRIVER_REGISTRATION_SUCCESS: "Driver registration successful with profile update and KYC documents created",
    ...
    DRIVER_DETAILED_PROFILE_RETURNED: "Driver detailed profile returned successfully",
    ...
    PAYOUT_REQUEST_SUBMITTED: "Payout request submitted successfully. Awaiting admin approval.",
...
exports.KYC_ERROR_MESSAGES = {
    KYC_NOT_FOUND: "KYC document not found",
    PROFILE_PICTURE_NOT_UPLOADED: "Profile picture is required for KYC approval",
    LICENSE_NOT_APPROVED: "Latest license must be approved before updating driver KYC status",
    NON_LICENSE_KYC_NOT_APPROVED: "At least one non-license KYC document (Aadhaar, PAN, or Passport) must be approved",
    INVALID_KYC_STATUS_TRANSITION: "Invalid KYC status transition",
};
exports.DRIVER_AVAILABILITY_ERROR_MESSAGES = {
    ...
    DRIVER_ALREADY_AVAILABLE: "Driver {{driverId}} already has an active availability record",
    INVALID_STATUS_TRANSITION: "Cannot transition from {{currentStatus}} to {{newStatus}}",
    EXPIRED_AVAILABILITY: "Cannot perform operation on expired availability record",
    DRIVER_PROFILE_NOT_FOUND: "Driver profile not found for user ID: {{userId}}",
    AVAILABILITY_EXCEPTION_NOT_FOUND: "Availability Exception is not found for id : {{exceptionId}}",
};
exports.SEARCH_DRIVER_ERROR_MESSAGES = {
...
//# sourceMappingURL=DriverMessages.js.map