...
exports.PAYMENT_MESSAGES = exports.PAYMENT_ERROR_MESSAGES = void 0;
exports.PAYMENT_ERROR_MESSAGES = {
    RIDE_NOT_COMPLETED: "Ride {{rideId}} is not completed. Payment can only be initiated for completed rides.",
    RIDE_NOT_COMPLETED_OR_CANCELLED: "Payment can only be initiated for completed or cancelled rides.",
    ...
    CASH_CONFIRMATION_UNAUTHORIZED: "Only the assigned driver can confirm cash payment for ride {{rideId}}.",
...
exports.PAYMENT_MESSAGES = {
    ...
    ONLINE_ORDER_CREATED: "Payment order created. Complete payment using the gateway.",
    WALLET_PAYMENT_SUCCESS: "Wallet payment processed successfully.",
    CASH_PAYMENT_INITIATED: "Cash payment initiated. Driver will collect payment.",
    PAYMENT_FAILED: "Payment has been marked as failed.",
};
//# sourceMappingURL=PaymentMessages.js.map