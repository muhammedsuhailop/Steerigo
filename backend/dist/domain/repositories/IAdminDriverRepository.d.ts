...
export interface IAdminDriverRepository extends IReadOnlyRepository<Driver>, IQueryableRepository<Driver> {
...
//# sourceMappingURL=IAdminDriverRepository.d.ts.map